...
and this leads to two lightboxes shown after clicking on an image attached to a review.', 'customer-reviews-woocommerce' ),
            ...
            array(
                ...
                'desc'    => __( 'Enable shortcodes and Gutenberg blocks', 'customer-reviews-woocommerce' ) . '<br><br>' .
                    ...
                    'This shortcode works ONLY on WooCommerce single product pages.', 'customer-reviews-woocommerce' ) . '<br><br>' .
                    ...
                    'replies to reviews will be shown.</li></ul>', 'customer-reviews-woocommerce' ) . '<br>' .
                    ...
                    '</ul>', 'customer-reviews-woocommerce' ) . '<br>' .
                    __( '- <strong>[cusrev_reviews_grid]</strong> shortcode is also available as <strong>Reviews Grid</strong> block in the new WordPress Gutenberg page editor (blocks require WordPress 5.0 or newer).', 'customer-reviews-woocommerce' ) . '<br><br>' .
                    ...
                    'products="" color_brdr="#ebebeb" color_bcrd="#fbfbfb" color_pr_bcrd="#f2f2f2" color_stars="#6bba70" shop_reviews="false" count_shop_reviews="1" inactive_products="false" autoplay="false" avatars="true" max_chars="0"]</b>. ' .
                    ...
                    '<b>"avatars"</b> argument accepts "true" or "false" and defines if the slider will show avatars of customers.</li><li>' .
                    '<b>"max_chars"</b> argument limits the number of characters that are displayed by default for each review. A \'Show More\' button will be added to display the remaining content for reviews that exceed this limit. If you do not want to limit the number of characters to display, set this argument to 0.</li></ul>', 'customer-reviews-woocommerce' ) . '<br>' .
                    __( '- <strong>[cusrev_reviews_slider]</strong> shortcode is also available as <strong>Reviews Slider</strong> block in the new WordPress Gutenberg page editor (blocks require WordPress 5.0 or newer).', 'customer-reviews-woocommerce' ),
