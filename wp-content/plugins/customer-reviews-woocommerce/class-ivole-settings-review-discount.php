    ...
    protected function init_settings() {
        $this->settings = array(
            array(
                ...
                'type'  => 'title',
                'desc'  => __( 'Customize CusRev settings for sending discount coupons to customers who left reviews. By enabling and using this feature, you agree to <a href="https://www.cusrev.com/terms.html" target="_blank">terms and conditions</a>.', 'customer-reviews-woocommerce' ),
    ...
    public function coupons_quick_link( $views ) {
        ...
        if ( is_admin() ) {
            ...
            if ( $result->found_posts > 0 ) {
                ...
                $views['ivole'] = sprintf( __('<a href="%s"'. $class .'>Manually Published <span class="count">(%d)</span></a>', 'customer-reviews-woocommerce' ), admin_url( 'edit.php?post_type=shop_coupon&ivole_coupon=0' ), $result->found_posts );
            }
        }
